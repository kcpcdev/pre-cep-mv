...
import org.kcpc.precepmv.config.KafkaProperties;
...
class PreChurchEnterprisePortalKafkaResourceIT {
    ...
    void setup() {
        ...
        PreChurchEnterprisePortalKafkaResource kafkaResource = new PreChurchEnterprisePortalKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/pre-church-enterprise-portal-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/pre-church-enterprise-portal-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
