...
@RestController
@RequestMapping("/api/pre-church-enterprise-portal-kafka")
public class PreChurchEnterprisePortalKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PreChurchEnterprisePortalKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PreChurchEnterprisePortalKafkaResource(KafkaProperties kafkaProperties) {
